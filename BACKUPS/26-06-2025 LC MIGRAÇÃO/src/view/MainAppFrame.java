...
public class MainAppFrame extends JFrame {
    ...
    // --- DECLARAÇÕES ÚNICAS DE COMPONENTES GUI (necessário para acesso global na classe) ---
    // ESTAS SÃO AS DECLARAÇÕES PRINCIPAIS E DEVEM ESTAR APENAS AQUI.
    // Elas são inicializadas dentro do método initComponents().
     ...
     */
    public MainAppFrame() {
        // --- INÍCIO DAS ALTERAÇÕES PARA REMOVER A BARRA DE TÍTULO E BOTÕES ---
        ...
        // SEMPRE A PRIMEIRA CHAMADA NO CONSTRUTOR DE UM FORM DO NETBEANS
        initComponents(); // Inicializa os componentes GUI gerados pelo NetBeans
...
//                "Conexão", JOptionPane.INFORMATION_MESSAGE);
    ...
    /**
     * Retorna a instância de AppConfig para acesso às configurações.
     * @return A instância de AppConfig.
     */
     ...
     * regerado pelo Editor de Formulários.
     */
